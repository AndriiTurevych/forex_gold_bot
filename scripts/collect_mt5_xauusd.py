    ...
    try:
        ...
        payload = {
            ...
            "instrument": {
                ...
                "trade_tick_value": float(_value(info, "trade_tick_value", 0)),
                "trade_tick_value_profit": float(_value(info, "trade_tick_value_profit", 0)),
                "trade_tick_value_loss": float(_value(info, "trade_tick_value_loss", 0)),
